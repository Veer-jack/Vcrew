...
function UserOnboarding({ step, onNext, vid }) {
  const { t } = useTranslation();
  const [d, setD] = useDraft(`VC_V_DRAFT_USER_${vid}`, { name: "", handle: "", city: "", country: "", countryOther: "", state: "", stateOther: "", language: [], age_group: "", gender: "", marital: "", has_kids: "", income: "", height: "", weight: "", skin_tone: "", hair_type: "", hair_length: "", body_type: "", occupation: "", food_pref: "", lifestyle: [], devices: [], hours: "" });
...
function TesterOnboarding({ step, onNext, error, vid }) {
  ...
  const [d, setD] = useDraft(`VC_V_DRAFT_TESTER_${vid}`, { name: "", handle: "", city: "", country: "", countryOther: "", state: "", stateOther: "", language: [], occupation: "", experience: "", industry: [], company: "", domains: [], certifications: [], tools: [], linkedin_url: "", portfolio_url: "", resume_filename: "", testing_bio: "", agreed: false });
  const set = (k, v) => setD(p => ({ ...p, [k]: v }));
  ...
  return (
    <div className="rise" style={{ maxWidth: 600, margin: "0 auto" }}>
      ...
      {step === 1 && (<><h2 style={{ fontSize: 22, fontWeight: 800, margin: "0 0 22px" }}>{t("vOnboarding.headers.professionalBackground", null, "Professional background")}</h2><Field label={t("vOnboarding.fields.role", null, "Role")} required><Chips options={ROLES} value={d.occupation || d.role} onChange={v => set("occupation", v)} multi={false} getLabel={optLabel(t, "roles")} /></Field><Field label={t("vOnboarding.fields.experience", null, "Experience")} required><Chips options={EXP} value={d.experience} onChange={v => set("experience", v)} multi={false} getLabel={optLabel(t, "experience")} /></Field><Field label={t("vOnboarding.fields.currentCompany", null, "Current company")} required hint={t("vOnboarding.hints.companyRequiredVerification", null, "Required for verification")}><input className="fin" value={d.company} onChange={e => set("company", e.target.value)} placeholder={t("vOnboarding.placeholders.companyExampleTester", null, "e.g. Infosys, Freelance QA")} /></Field><Field label={t("vOnboarding.fields.industry", null, "Industry")} required action={<SelectAllToggle options={INDUSTRIES} value={d.industry} onChange={v => set("industry", v)} />}><Chips options={INDUSTRIES} value={d.industry} onChange={v => set("industry", v)} getLabel={optLabel(t, "industries")} /></Field><Field label={t("vOnboarding.fields.testingDomains", null, "Testing domains")} action={<SelectAllToggle options={TESTER_DOMAINS} value={d.domains} onChange={v => set("domains", v)} />}><Chips options={TESTER_DOMAINS} value={d.domains} onChange={v => set("domains", v)} getLabel={optLabel(t, "testerDomains")} /></Field><Field label={t("vOnboarding.fields.certifications", null, "Certifications")} action={<SelectAllToggle options={CERT} value={d.certifications} onChange={v => set("certifications", v)} />}><Chips options={CERT} value={d.certifications} onChange={v => set("certifications", v)} getLabel={optLabel(t, "certifications")} /></Field><Field label={t("vOnboarding.fields.tools", null, "Tools")} action={<SelectAllToggle options={TECH_TOOLS} value={d.tools} onChange={v => set("tools", v)} />}><Chips options={TECH_TOOLS} value={d.tools} onChange={v => set("tools", v)} getLabel={optLabel(t, "techTools")} /></Field></>)}
