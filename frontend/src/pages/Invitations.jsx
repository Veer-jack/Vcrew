          ...
          {filtered.map(g => {
            ...
            return (
              <div key={g.validator.id} className="card" style={{ padding: 0, overflow: "hidden" }}>
                ...
                {/* Pulled out of the name column (indented past the avatar)
                    so this starts at the same left edge as the avatar
                    itself, same fix as the Audience Explorer card. */}
                <div className="row" style={{ gap: 10, alignItems: "center", padding: "0 20px 12px" }}>
                  {g.validator.trust > 0 ? (
