...
(function () {
  ...
  const T = {
    ...
    asBuilder: "作为一名建筑商",
    asBuilderDesc: "运行&amp;管理验证",
    asValidator: "作为验证者",
    asValidatorDesc: "接任务&amp;赚",
    getStarted: "开始使用",
    createAccount: "创建一个免费帐户",
    imBuilder: "我是一名建筑商",
    imBuilderDesc: "与真实用户一起测试我的产品",
    imValidator: "我是验证者",
    imValidatorDesc: "测试产品&amp;得到报酬",
    ...
    settings: "设置",
    signOut: "登出",
    signedInAs: "您当前登录的身份为",
    signOutFirst: "请先退出才能继续作为",
  };
