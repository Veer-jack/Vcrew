...
(function () {
  ...
  const T = {
    ...
    asBuilder: "एक बिल्डर के रूप में",
    asBuilderDesc: "चलाएँ &amp; सत्यापन प्रबंधित करें",
    asValidator: "एक सत्यापनकर्ता के रूप में",
    asValidatorDesc: "मिशन उठाओ & amp; कमाना",
    getStarted: "शुरू हो जाओ",
    createAccount: "एक नि: शुल्क खाता बनाएं",
    imBuilder: "मैं एक बिल्डर हूं",
    imBuilderDesc: "वास्तविक उपयोगकर्ताओं के साथ मेरे उत्पाद का परीक्षण करें",
    imValidator: "मैं एक सत्यापनकर्ता हूँ",
    imValidatorDesc: "परीक्षण उत्पाद एवं amp; भुगतान प्राप्त करना",
