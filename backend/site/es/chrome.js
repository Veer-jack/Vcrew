...
(function () {
  ...
  const T = {
    ...
    ideaValidation: "Validación de ideas",
    ...
    asBuilder: "Como constructor",
    asBuilderDesc: "Correr y gestionar validaciones",
    asValidator: "Como validador",
    asValidatorDesc: "Recoge misiones y amp; ganar",
    getStarted: "empezar",
    createAccount: "Crea una cuenta gratis",
    imBuilder: "soy un constructor",
    imBuilderDesc: "Pruebe mi producto con usuarios reales",
    imValidator: "soy un validador",
    imValidatorDesc: "Productos de prueba y cobrar",
    ...
    settings: "Ajustes",
    signOut: "desconectar",
    signedInAs: "Actualmente estás registrado como",
    signOutFirst: "Por favor, cierre sesión primero para continuar como",
  };
