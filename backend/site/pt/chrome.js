...
(function () {
  ...
  const T = {
    forBuilders: "Para Construtores",
    ideaValidation: "Validação de ideias",
    userTesting: "Teste de usuário",
    forValidators: "Para validadores",
    useCases: "Casos de uso",
    about: "Sobre",
    logIn: "Conecte-se",
    signInAccount: "Faça login na sua conta",
    asBuilder: "Como Construtor",
    asBuilderDesc: "Correr e correr gerenciar validações",
    asValidator: "Como validador",
    asValidatorDesc: "Pegue missões e missões. ganhar",
    getStarted: "Comece",
    createAccount: "Crie uma conta gratuita",
    imBuilder: "Eu sou um construtor",
    imBuilderDesc: "Teste meu produto com usuários reais",
    imValidator: "Eu sou um validador",
    imValidatorDesc: "Teste produtos e ser pago",
    startValidating: "Comece a validar",
    builderLogin: "Login do construtor",
    becomeValidator: "Torne-se um validador",
    validatorLogin: "Login do validador",
    blurb: "ValidationCrew é uma rede de validação humana que conecta organizações com usuários, testadores e especialistas correspondentes para validar produtos, ideias e decisões por meio de feedback humano estruturado.",
    platform: "Plataforma",
    company: "Empresa",
    resources: "Recursos",
    legalStr: "Jurídico",
    ...
    signOut: "sair",
    signedInAs: "Você está atualmente conectado como",
    signOutFirst: "Por favor saia primeiro para continuar como",
  };
