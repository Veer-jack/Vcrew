...
(function () {
  ...
  const T = {
    forBuilders: "Pour les constructeurs",
    ideaValidation: "Validation des idées",
    userTesting: "Tests utilisateur",
    forValidators: "Pour les validateurs",
    useCases: "Cas d'utilisation",
    about: "À propos",
    logIn: "Se connecter",
    signInAccount: "Connectez-vous à votre compte",
    asBuilder: "En tant que constructeur",
    asBuilderDesc: "Exécuter et amp; gérer les validations",
    asValidator: "En tant que validateur",
    asValidatorDesc: "Reprenez des missions et des missions. gagner",
    getStarted: "Commencer",
    createAccount: "Créez un compte gratuit",
    imBuilder: "je suis un constructeur",
    imBuilderDesc: "Testez mon produit avec de vrais utilisateurs",
    imValidator: "Je suis un validateur",
    imValidatorDesc: "Testez les produits et être payé",
    startValidating: "Commencez à valider",
    builderLogin: "Connexion constructeur",
    becomeValidator: "Devenez validateur",
    validatorLogin: "Connexion du validateur",
    blurb: "ValidationCrew est un réseau de validation humaine qui connecte les organisations avec des utilisateurs, des testeurs et des experts correspondants pour valider les produits, les idées et les décisions grâce à un retour humain structuré.",
    ...
    signOutFirst: "Veuillez d'abord vous déconnecter pour continuer en tant que",
  };
