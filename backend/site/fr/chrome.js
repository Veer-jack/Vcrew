...
(function () {
  ...
  const T = {
    ...
    blurb: "Le réseau mondial de validation humaine — reliant les constructeurs aux bonnes personnes pour valider les produits, les idées et les décisions avant leur expédition.",
