...
(function () {
  ...
  const T = {
    ...
    forValidators: "Для валидаторов",
    useCases: "Варианты использования",
    about: "О",
    logIn: "Авторизоваться",
    signInAccount: "Войдите в свою учетную запись",
    asBuilder: "Как строитель",
    asBuilderDesc: "Запустить и усилить; управлять проверками",
    asValidator: "В качестве валидатора",
    asValidatorDesc: "Выполняйте миссии и amp; зарабатывать",
    getStarted: "Начать",
    createAccount: "Создать бесплатную учетную запись",
    imBuilder: "Я строитель",
    imBuilderDesc: "Протестируйте мой продукт на реальных пользователях",
    imValidator: "Я валидатор",
    imValidatorDesc: "Тестовые продукты и усилители; получать деньги",
    startValidating: "Начать проверку",
    builderLogin: "Вход для строителя",
    becomeValidator: "Стать валидатором",
    validatorLogin: "Вход в валидатор",
    blurb: "ValidationCrew — это сеть проверки, объединяющая организации с соответствующими пользователями, тестировщиками и экспертами для проверки продуктов, идей и решений посредством структурированной обратной связи между людьми.",
    platform: "Платформа",
    company: "Компания",
    resources: "Ресурсы",
    legalStr: "Юридический",
    careers: "Карьера",
    blog: "Блог",
    press: "Нажимать",
    helpCenter: "Справочный центр",
    trustSafety: "Доверие и безопасность",
    apiDocs: "Документация по API",
    status: "Статус",
    ...
    signOutFirst: "Пожалуйста, сначала выйдите из системы, чтобы продолжить работу в качестве",
  };
