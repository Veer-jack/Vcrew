...
(function () {
  ...
  const T = {
    ...
    asBuilder: "كباني",
    asBuilderDesc: "تشغيل &amp; إدارة عمليات التحقق من الصحة",
    asValidator: "كمدقق",
    asValidatorDesc: "التقاط المهام &amp; يكسب",
    getStarted: "ابدأ",
    createAccount: "إنشاء حساب مجاني",
    imBuilder: "أنا منشئ",
    imBuilderDesc: "اختبر منتجي مع مستخدمين حقيقيين",
    imValidator: "أنا مدقق",
    imValidatorDesc: "منتجات الاختبار &amp; الحصول على أموال",
    startValidating: "ابدأ بالتحقق",
    builderLogin: "تسجيل الدخول منشئ",
    becomeValidator: "كن مدققًا",
    validatorLogin: "تسجيل الدخول المدقق",
    blurb: "ValidationCrew عبارة عن شبكة تحقق بشرية تربط المؤسسات بالمستخدمين والمختبرين والخبراء المتطابقين للتحقق من صحة المنتجات والأفكار والقرارات من خلال التعليقات البشرية المنظمة.",
    platform: "منصة",
    company: "شركة",
    resources: "موارد",
    legalStr: "قانوني",
