...
(function () {
  ...
  const T = {
    forBuilders: "নির্মাতাদের জন্য",
    ideaValidation: "আইডিয়া ভ্যালিডেশন",
    userTesting: "ব্যবহারকারী পরীক্ষা",
    forValidators: "যাচাইকারীদের জন্য",
    useCases: "কেস ব্যবহার করুন",
    about: "সম্পর্কে",
    logIn: "লগ ইন করুন",
    signInAccount: "আপনার অ্যাকাউন্টে সাইন ইন করুন",
    asBuilder: "একজন নির্মাতা হিসেবে",
    asBuilderDesc: "চালান &amp; বৈধতা পরিচালনা করুন",
    asValidator: "একটি যাচাইকারী হিসাবে",
    asValidatorDesc: "মিশন পিক আপ &amp; উপার্জন",
    getStarted: "শুরু করুন",
    createAccount: "একটি বিনামূল্যে অ্যাকাউন্ট তৈরি করুন",
    imBuilder: "আমি একজন বিল্ডার",
    imBuilderDesc: "প্রকৃত ব্যবহারকারীদের সাথে আমার পণ্য পরীক্ষা করুন",
    imValidator: "আমি একজন যাচাইকারী",
    imValidatorDesc: "পরীক্ষা পণ্য &amp; বেতন পেতে",
    startValidating: "যাচাই করা শুরু করুন",
    builderLogin: "বিল্ডার লগইন",
    becomeValidator: "একজন যাচাইকারী হন",
    validatorLogin: "যাচাইকারী লগইন",
    blurb: "ValidationCrew হল একটি মানবিক বৈধকরণ নেটওয়ার্ক যা সংগঠনগুলিকে মিলিত ব্যবহারকারী, পরীক্ষক এবং বিশেষজ্ঞদের সাথে পণ্য, ধারণা এবং সিদ্ধান্তগুলিকে কাঠামোগত মানব প্রতিক্রিয়ার মাধ্যমে যাচাই করার জন্য সংযুক্ত করে।",
    ...
    signedInAs: "আপনি বর্তমানে একটি হিসাবে সাইন ইন করেছেন৷",
    signOutFirst: "একটি হিসাবে চালিয়ে যেতে অনুগ্রহ করে প্রথমে সাইন আউট করুন৷",
  };
