...
(function () {
  ...
  const T = {
    forBuilders: "بلڈرز کے لیے",
    ideaValidation: "آئیڈیا کی توثیق",
    userTesting: "صارف کی جانچ",
    forValidators: "توثیق کرنے والوں کے لیے",
    useCases: "کیسز استعمال کریں۔",
    about: "کے بارے میں",
    logIn: "لاگ ان کریں۔",
    signInAccount: "اپنے اکاؤنٹ میں سائن ان کریں۔",
    asBuilder: "بطور بلڈر",
    asBuilderDesc: "چلائیں &amp; توثیق کا انتظام کریں",
    asValidator: "بطور تصدیق کنندہ",
    asValidatorDesc: "پک اپ مشنز اور کمائیں",
    getStarted: "شروع کریں",
    createAccount: "ایک مفت اکاؤنٹ بنائیں",
    imBuilder: "میں ایک بلڈر ہوں۔",
    imBuilderDesc: "حقیقی صارفین کے ساتھ میری مصنوعات کی جانچ کریں۔",
    imValidator: "میں توثیق کرنے والا ہوں۔",
    imValidatorDesc: "مصنوعات کی جانچ کریں اور ادائیگی حاصل کریں",
    startValidating: "تصدیق کرنا شروع کریں۔",
    builderLogin: "بلڈر لاگ ان",
    becomeValidator: "تصدیق کنندہ بنیں۔",
    validatorLogin: "تصدیق کنندہ لاگ ان",
    blurb: "ValidationCrew ایک انسانی توثیق کا نیٹ ورک ہے جو تنظیموں کو مماثل صارفین، ٹیسٹرز اور ماہرین کے ساتھ مربوط انسانی تاثرات کے ذریعے مصنوعات، خیالات اور فیصلوں کی توثیق کرتا ہے۔",
    platform: "پلیٹ فارم",
    company: "کمپنی",
    resources: "وسائل",
    legalStr: "قانونی",
    ...
    signedInAs: "آپ فی الحال a کے بطور سائن ان ہیں۔",
    signOutFirst: "بطور A کے جاری رکھنے کے لیے براہ کرم پہلے سائن آؤٹ کریں۔",
  };
